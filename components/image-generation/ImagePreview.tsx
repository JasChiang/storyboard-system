        ...
        return (
            <div className="relative w-full aspect-video bg-zinc-900/50 rounded-lg border border-zinc-700 
                ...
                <div className="flex flex-col items-center gap-3">
                    ...
                    <p className="text-sm text-zinc-400">生成圖片中...</p>
                </div>
            </div>
        );
    }
        ...
        return (
            <div className="relative w-full aspect-video bg-zinc-900/50 rounded-lg border border-zinc-700 
                ...
                <div className="flex flex-col items-center gap-2">
                    ...
                    <p className="text-sm text-zinc-500">尚未生成圖片</p>
                </div>
            </div>
        );
    }
        ...
        <div className="space-y-3">
            <div className="relative group">
                <img
                    ...
                    className={`
            w-full aspect-video object-contain rounded-lg border border-zinc-700 
