...
本系統提供三種視頻導出方式，全部採用開源免費方案，適合商業使用。
...
- **最低要求**: 至少一個場景有圖片或視頻
- **推薦**: 所有場景都有視頻素材，效果最佳
- **圖片轉視頻**: FFmpeg 會自動將圖片轉換為靜態視頻片段

---

## 🚀 未來改進計劃

- [ ] 添加更多轉場效果（Dissolve, Slide, Zoom）
- [ ] 支援背景音樂添加
- [ ] 字幕樣式自定義（字體、顏色、位置）
- [ ] 實時預覽功能
- [ ] 渲染隊列管理
- [ ] 導出多種分辨率（720p, 1080p, 4K）
- [ ] 場景特效（Ken Burns, Zoom）
